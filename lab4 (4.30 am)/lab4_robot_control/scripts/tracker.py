...
class tracker(Node):
    ...
    def __init__(self):
        ...
        with open(r'lab4_robot_control/config/tracker_config.yaml') as file:
            K_config = yaml.load(file, Loader=yaml.FullLoader)
        self.Kp = K_config["Kp"][0]
        self.Ki = K_config["Ki"][0]
    ...
    def enableTracker_set(self,req,res):
        self.enableTracker = req.tracker_enable.data
        return res 
